...
# Assume PixelProject-VERSION-DATE-TYPE-*.zip
...
adb shell "killall com.pixelproject.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.pixelproject.updater/databases/updates.db" \
